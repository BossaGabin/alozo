...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><h4><center>{{ __('Inscription') }}</center></h4></div><br>

                <div class="card-body">
                    <div class="d-flex justify-content-center py-4">
                        <a href="/" class="logo d-flex align-items-center w-auto">
                          <img src="assets/img/LOGO_Officiel2.jpg" alt="" style="border-radius: 200px;margin-top:5%" width="80" height="80">
