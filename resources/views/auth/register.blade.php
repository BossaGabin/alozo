                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center"
                            ...
                            <div class="d-flex justify-content-center py-4" style="position: relative">
                                <a href="/" class="logo d-flex align-items-center w-auto">
                                    <img src="{{ asset('assets/img/LOGO_Officiel2.jpg') }}" alt=""
                                        style="border-radius: 200px" width="100" height="100">
                                </a>
                            </div><!-- End Logo -->
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" novalidate action="{{ route('register') }}"
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <div class="invalid-feedback">Votre ville.</div>
                                        </div>

                                        <div class="col-md-6 form-group">
                                            <label id="phone" type="text"
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label id="password" type="password" class="form-label fs-6">Mot de
                                                passe:</label>
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label for="password-confirm" type="password"
                                                class="form-label fs-6">Confirmez le mot de passe:</label>
                                        ...
                                        <div class="col-md-12 form-group">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label fs-6" for="acceptTerms">J'accepte vos
                                                    <a href="#">termes et conditions</a></label>
                                                <div class="invalid-feedback">!!</div>
                                            </div>
                                        </div>
                                        <div class="col-8 " style="margin-left: 15%">
                                            <button class="btn  btn-order w-100" type="submit">Creer un
                                                compte</button>
                                        </div>
                                        <div class="col-md-12">
                                            <center>
                                                <label class="small mb-0 fs-6 ">Avez-vous deja un compte? <a
                                                        href="{{ route('login') }}">connectez-vous</a></label>
                                            </center>
                                        </div>
                                    </form>
