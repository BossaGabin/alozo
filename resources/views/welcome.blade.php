    ...
    <main id="main">
        ...
        <section id="hero">
            <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
                <h1 class="mb-4 pb-0 justify-content-center" style="font-size: 25px;">Plateforme facilitant la mise en
                    relation entre <br> les clients potentiels et les artisans qualifiés.</h1>
                <span>
                    <a href="{{ route('register') }}" class="about-btn scrollto btn-register fs-6">S'inscrire</a>
                    <a href="{{ route('login') }}" class="about-btn scrollto btn-register fs-6">Se connecter</a>
                </span>
                            ...
                            <div class="bloc1">
                                <div class="row">
                                    ...
                                    <a href="/artisans/{{ $artisan->id }}" class="btn btn-order" role="button"
                                        style="width: 60% !important"><span>Consulter</span></a><br><br>
                                </div>
                            </div>
                        </div>
                    </div>
