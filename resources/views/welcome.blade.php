...
@section('content') <main id="main">
 ...
 <section id="hero">
  <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
    <h1 class="mb-4 pb-0 justify-content-center" style="font-size: 25px;">Plateforme facilitant la mise en relation entre <br> les clients potentiels et les artisans qualifiés.</h1>
    <a href="{{route('register')}}" class="about-btn scrollto btn-register fs-6">INSCRIPTION</a>
    ...
    <div class="row">
      <div class="col-md-2">
          ...
          <div class="col-md-6 d-flex">
            <input type="text"  class="form-control" placeholder="Rechercher un artisan" style="border-radius:5px 0px 0px 5px;margin-left:5%">
